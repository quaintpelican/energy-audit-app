...
- [REPORT_RENDERING_SPEC.md](REPORT_RENDERING_SPEC.md) — V7.0 professional report model, deterministic content, branding, figures, appendices, revisions, integrity, and HTML/PDF behavior.
