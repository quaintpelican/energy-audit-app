...
# Audist Data Schema — V4.0 Phase 1
...
- `status`: `Calculated` or `Needs Recalculation`;
- `formulaDescription`;
...
- `ecmId`, `systemRecordIds[]`, `equipmentRecordIds[]`, and `sourceReferences[]` using stable UUID relationships;
